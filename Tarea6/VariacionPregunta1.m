...
% Posiciones deseadas (deltas)
delta_ji = [0 2; -2 0; 0 -2; 2 0]; % [delta_1; delta_2; delta_3; delta_4]
p_star = zeros(size(x)); % Inicializar el vector de posiciones deseadas

% Convertir las posiciones relativas deseadas a posiciones absolutas
for i = 1:length(delta_ji)
...
% Simulación con control de formación
for k = 1:iteraciones
